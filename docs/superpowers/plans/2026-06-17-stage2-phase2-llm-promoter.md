...
- gemma4 path at runtime is `scripts/claude-gemma4` → proxy `:18080` → 192.168.199.199; tests never hit it (FakeAgentClient / stub only). `test_atomizer_llm_live.py` stays opt-in.
