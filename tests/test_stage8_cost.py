            ...
            providers={
                ...
                "cpt": ProviderSnapshot(
                    ...
                    accounts=(
                        ...
                        CopilotAccountUsage("org-a", "arc", "company", 127, 300, "github_org_billing"),
                    ),
                ),
            },
        )
    ...
    def test_collect_copilot_attributes_aiu_to_arc_and_premium_to_haman(self) -> None:
        cfg = CostConfig(
            copilot_accounts=(
                ...
                cost_config_module.CopilotAccountConfig(
                    account_id="org-a", label="arc", kind="company", monthly_allowance=300,
                ),
            )
        )
            ...
            providers={
                "cpt": ProviderSnapshot(
                    ...
                    accounts=(
                        ...
                        CopilotAccountUsage(
                            account_id="org-a", label="arc", kind="company",
            ...
            "providers": {
                "cpt": {
                    ...
                    "accounts": [
                        ...
                        {
                            "id": "org-a", "label": "arc", "kind": "company",
                            "used_requests": None, "monthly_allowance": 300,
